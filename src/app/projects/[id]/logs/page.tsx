import { getGenerationLogs, getProject } from "@/lib/store";
...
export default async function GenerationLogsPage({ params }: Props) {
  const { id } = await params;
  const [logs, project] = await Promise.all([getGenerationLogs(id), getProject(id)]);
...
function LogCard({ log }: { log: GenerationLog }) {
