  ...
  return (
    <div className="flex items-center gap-2">
      <button
        ...
        disabled={servings <= 1}
        className="w-7 h-7 rounded-full border border-slate-300 flex items-center justify-center hover:bg-slate-100 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
