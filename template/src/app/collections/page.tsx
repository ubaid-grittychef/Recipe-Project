          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {collectionsWithCounts.map((collection) => (
              <Link
                ...
                className="group flex flex-col rounded-xl border border-[#ede8e0] bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md"
              >
                <span className="text-4xl">{collection.emoji}</span>
                <h2
                  className="mt-3 text-lg font-bold text-slate-900 group-hover:text-orange-600 transition-colors"
